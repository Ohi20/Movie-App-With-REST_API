                   ...
                   <Row>
                        <Col className=''>
                            ...
                            <ul className='socialIconsList'>
                                ...
                                <li>
                                    <a rel="noreferrer" href="https://myaccount.google.com/?hl=en&utm_source=OGB&utm_medium=act" target="_blank">
                                        <BsGoogle />
                                    </a>
                                </li>
                                <li>
                        ...
                        <Col className='col-12'>
                            <div className="footerCopyright">
                                <small>© Cenephilia , 2023. Developed and Designed  by <a href="https://www.instagram.com/_probaad/" target="_blank" rel="noreferrer">Ashraf Ohi</a>.</small>
                            </div>
                        </Col>
                   </Row>
                </Container>
